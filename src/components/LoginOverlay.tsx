...
const LoginOverlay = () => {
    ...
    return (
        <div className="fixed inset-0 z-[200] flex items-end md:items-center justify-center bg-black/40 backdrop-blur-sm transition-all duration-300 animate-in fade-in">
            ...
            <div className="relative w-full md:max-w-md bg-white rounded-t-[2.5rem] md:rounded-[2rem] p-8 shadow-2xl animate-in slide-in-from-bottom-20 duration-500 overflow-hidden">
                <button
                    onClick={closeLogin}
                ...
                {/* LOGIN VIEW */}
                {view === "LOGIN" && (
                    <div className="space-y-6 pt-4 text-center animate-in fade-in slide-in-from-right-10 duration-300">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 text-sm font-medium">Login to continue to HomeRun</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-4 pt-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-16 pr-4 font-bold text-gray-900 focus:outline-none focus:border-[#45a049] focus:bg-white transition-all text-lg"
                                />
                            </div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-12 pr-12 font-bold text-gray-900 focus:outline-none focus:border-[#45a049] focus:bg-white transition-all text-lg"
                                />
                                <button
                                    type="button"
                ...
                {view === "REGISTER" && (
                    <div className="space-y-6 pt-4 text-center animate-in fade-in slide-in-from-right-10 duration-300">
                        ...
                        <div className="space-y-2">
                            ...
                            <p className="text-gray-500 text-sm font-medium">Join us and start ordering!</p>
                        </div>
                        ...
                        <form onSubmit={handleRegister} className="space-y-4 pt-2">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-12 pr-4 font-bold text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-lg"
                                />
                            </div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    placeholder="Phone Number"
                                    className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-16 pr-4 font-bold text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-lg"
                                />
                            </div>
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-12 pr-12 font-bold text-gray-900 focus:outline-none focus:border-blue-500 focus:bg-white transition-all text-lg"
                                />
                                <button
                                    type="button"
                                    onClick={() => setShowPassword(!showPassword)}
                            ...
                            <Button
                                type="submit"
                                disabled={isLoading}
                                className="w-full bg-blue-500 hover:bg-blue-600 h-14 rounded-2xl font-black text-lg gap-2 shadow-lg shadow-blue-100 transition-all active:scale-[0.98]"
                            >
                                {isLoading ? (
                                    <div className="w-6 h-6 border-4 border-white border-t-transparent rounded-full animate-spin" />
                                ) : "CREATE ACCOUNT"}
                ...
                {view === "FORGOT_PASSWORD" && (
                    <div className="space-y-6 pt-4 text-center animate-in fade-in slide-in-from-right-10 duration-300">
                        ...
                        <div className="w-16 h-16 bg-orange-50 rounded-2xl flex items-center justify-center mx-auto mb-2 text-orange-500">
                        ...
                        {forgotStep === "PHONE" && (
                            <form onSubmit={handleForgotPhoneSubmit} className="space-y-4 pt-4">
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        placeholder="Phone Number"
                                        className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-16 pr-4 font-bold text-gray-900 focus:outline-none focus:border-orange-500 focus:bg-white transition-all text-lg"
                                    />
                                </div>
                                <Button
                                    type="submit"
                                    disabled={isLoading || forgotPhone.length !== 10}
                                    className="w-full bg-orange-500 hover:bg-orange-600 h-14 rounded-2xl font-black text-lg gap-2 shadow-lg shadow-orange-100 transition-all active:scale-[0.98]"
                                >
                                    {isLoading ? (
                                        <div className="w-6 h-6 border-4 border-white border-t-transparent rounded-full animate-spin" />
                                    ) : (
                        ...
                        {forgotStep === "VERIFY" && (
                            <form onSubmit={handleVerifyOtp} className="space-y-6 pt-2">
                                <div className="space-y-2">
                                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Enter OTP</label>
                                    <div className="flex justify-center gap-3">
                                        {otp.map((digit, idx) => (
                                            <input
                                                ...
                                                className="w-12 h-14 text-center bg-gray-50 border-2 border-gray-100 rounded-xl text-xl font-black text-orange-500 focus:outline-none focus:border-orange-500 focus:bg-white transition-all"
                                            />
                                        ))}
                                    </div>
                                    <p className="text-[10px] text-gray-400 font-medium">Use 1234 as OTP</p>
                                </div>
                                <Button
                                    type="submit"
                                    disabled={isLoading}
                            ...
                            <form onSubmit={handleResetPassword} className="space-y-4 pt-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-12 pr-12 font-bold text-gray-900 focus:outline-none focus:border-orange-500 focus:bg-white transition-all text-lg"
                                    />
                                    <button
                                        type="button"
                                        onClick={() => setShowPassword(!showPassword)}
                                ...
                                <div className="relative group">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-gray-50 border-2 border-gray-50 rounded-2xl py-4 pl-12 pr-4 font-bold text-gray-900 focus:outline-none focus:border-orange-500 focus:bg-white transition-all text-lg"
                                    />
                                </div>

                                <div className="text-left text-[10px] text-gray-400 space-y-1 font-medium bg-gray-50 p-3 rounded-xl border border-gray-100">
